...
/* unused harmony import specifier */ var esm_shallow;
...
function useNodes() {
    const nodes = useStore(nodesSelector, esm_shallow);
    return nodes;
}

const edgesSelector = (state) => state.edges;
function useEdges() {
    const edges = useStore(edgesSelector, esm_shallow);
    return edges;
}
...
function useViewport() {
    const viewport = useStore(viewportSelector, esm_shallow);
    return viewport;
}
