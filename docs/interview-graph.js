...
const Controls = ({ style, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children, position = 'bottom-left', }) => {
    ...
    const { isInteractive, minZoomReached, maxZoomReached } = useStore(dist_esm_selector, shallow$1);
...
var Controls$1 = (0,react.memo)(Controls);
...
const graph_authors_namespaceObject = /*#__PURE__*/JSON.parse('{"t":[{"id":"1","name":"Руслан Хайруллин","image":"/aKm/images/useful/author-roma.png","connections":["2"]},{"id":"2","name":"Рома Кужель","image":"/aKm/images/useful/author-roma.png","connections":["4"]},{"id":"3","name":"Екатерина Гомзякова","image":"/aKm/images/useful/author-roma.png","connections":["1"]},{"id":"4","name":"Захар День","image":"/aKm/images/useful/author-roma.png","connections":["5"]},{"id":"5","name":"Анна Смирнова","image":"/aKm/images/useful/author-roma.png","connections":["8"]},{"id":"6","name":"Дмитрий Иванов","image":"/aKm/images/useful/author-roma.png","connections":["7"]},{"id":"7","name":"Мария Петрова","image":"/aKm/images/useful/author-roma.png","connections":["9"]},{"id":"8","name":"Алексей Козлов","image":"/aKm/images/useful/author-roma.png","connections":["10"]},{"id":"9","name":"Елена Волкова","image":"/aKm/images/useful/author-roma.png","connections":[]},{"id":"10","name":"Игорь Соколов","image":"/aKm/images/useful/author-roma.png","connections":["9"]},{"id":"11","name":"Ольга Новикова","image":"/aKm/images/useful/author-roma.png","connections":["12"]},{"id":"12","name":"Сергей Морозов","image":"/aKm/images/useful/author-roma.png","connections":["13"]},{"id":"13","name":"Наталья Павлова","image":"/aKm/images/useful/author-roma.png","connections":["14"]},{"id":"14","name":"Андрей Федоров","image":"/aKm/images/useful/author-roma.png","connections":["16"]},{"id":"15","name":"Татьяна Михайлова","image":"/aKm/images/useful/author-roma.png","connections":["11"]},{"id":"16","name":"Владимир Васильев","image":"/aKm/images/useful/author-roma.png","connections":["18"]},{"id":"17","name":"Юлия Кузнецова","image":"/aKm/images/useful/author-roma.png","connections":["15"]},{"id":"18","name":"Николай Егоров","image":"/aKm/images/useful/author-roma.png","connections":["20"]},{"id":"19","name":"Ирина Сидорова","image":"/aKm/images/useful/author-roma.png","connections":["17"]},{"id":"20","name":"Максим Григорьев","image":"/aKm/images/useful/author-roma.png","connections":[]}]}');
...
function O_canvasCards_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function O_canvasCards_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return O_canvasCards_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? O_canvasCards_arrayLikeToArray(r, a) : void 0; } }
function O_canvasCards_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function O_canvasCards_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function O_canvasCards_arrayWithHoles(r) { if (Array.isArray(r)) return r; }
...
var UserCardNode = function UserCardNode(_ref) {
  var data = _ref.data;
  return /*#__PURE__*/react.createElement("div", {
    className: "O_UserCard"
...
var CurvyEdge = function CurvyEdge(_ref2) {
  var id = _ref2.id,
...
var FlowContent = function FlowContent(_ref3) {
  var nodes = _ref3.nodes,
    edges = _ref3.edges,
    onNodesChange = _ref3.onNodesChange,
    onEdgesChange = _ref3.onEdgesChange,
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    minZoom: 0.1,
    maxZoom: 2
  }, /*#__PURE__*/react.createElement(Controls$1, null)));
};
var O_canvasCards = function O_canvasCards() {
  var _useNodesState = useNodesState([]),
    _useNodesState2 = O_canvasCards_slicedToArray(_useNodesState, 3),
    nodes = _useNodesState2[0],
    setNodes = _useNodesState2[1],
    onNodesChange = _useNodesState2[2];
  var _useEdgesState = useEdgesState([]),
    _useEdgesState2 = O_canvasCards_slicedToArray(_useEdgesState, 3),
    edges = _useEdgesState2[0],
    setEdges = _useEdgesState2[1],
    onEdgesChange = _useEdgesState2[2];
  var _useState = (0,react.useState)(true),
    _useState2 = O_canvasCards_slicedToArray(_useState, 2),
    loading = _useState2[0],
    setLoading = _useState2[1];
  var _useState3 = (0,react.useState)(null),
    _useState4 = O_canvasCards_slicedToArray(_useState3, 2),
    error = _useState4[0],
    setError = _useState4[1];
  var processGraphData = function processGraphData() {
    var authorsArray = graph_authors_namespaceObject.t.slice(0, 20);
    console.log('Loaded authors:', authorsArray.length);
    console.log('First author:', authorsArray[0]);
    var pseudoHash = function pseudoHash(s) {
      var h = 2166136261 >>> 0;
    ...
    var nodeW = 348;
    var nodeH = 260;
    var nodeDiameter = Math.max(nodeW, nodeH);
    var n = Math.max(1, authorsArray.length);
    var cx = Math.round(vw / 2);
    var cy = Math.round(vh / 2);
    var baseRadius = Math.max(nodeDiameter, Math.ceil(nodeDiameter * 0.9));
    var ringGap = Math.round(nodeDiameter * 0.35);
    var remaining = authorsArray.length;
    var ringIndex = 0;
    var processedNodes = [];
    var idx = 0;
    while (remaining > 0) {
      var radius = baseRadius + ringIndex * (nodeDiameter + ringGap);
      var spacing = nodeDiameter * 0.95;
      var capNoise = pseudoHash('cap' + ringIndex) % 200 / 1000 + 0.85;
      var capacity = Math.max(1, Math.floor(2 * Math.PI * radius / spacing * capNoise));
      var placeCount = Math.min(capacity, remaining);
      for (var k = 0; k < placeCount; k++) {
        var author = authorsArray[idx];
        var ringPhase = pseudoHash('ring' + ringIndex) % 1000 / 1000 * (2 * Math.PI);
        var angle = ringPhase + 2 * Math.PI * k / placeCount;
        var seed = pseudoHash(String(author.id) + String(idx));
        var angleJitter = (seed % 1000 / 1000 - 0.5) * (2 * Math.PI / placeCount) * 0.6;
        var radialJitter = ((seed >>> 10) % 1000 / 1000 - 0.5) * Math.min(80, radius * 0.12);
        var a = angle + angleJitter;
        var r = radius + radialJitter;
        var px = cx + Math.cos(a) * r - nodeW / 2;
        var py = cy + Math.sin(a) * r - nodeH / 2;
        processedNodes.push({
          id: String(author.id),
          type: 'userCard',
          data: {
      ...
      ringIndex++;
      if (baseRadius + ringIndex * (nodeDiameter + ringGap) > Math.max(vw, vh) * 2) {
        var paddingX = 24;
        var paddingY = 24;
        var cols = Math.ceil(Math.sqrt(remaining));
        for (var j = 0; j < remaining; j++) {
          var _author = authorsArray[idx];
          var col = j % cols;
          var row = Math.floor(j / cols);
          var x = cx - Math.floor(cols * (nodeW + paddingX) / 2) + col * (nodeW + paddingX);
          var y = cy + radius + row * (nodeH + paddingY);
          processedNodes.push({
            id: String(_author.id),
            type: 'userCard',
            data: {
              label: _author.name,
              image: _author.image
    ...
    authorsArray.forEach(function (author) {
      if (author.connections && Array.isArray(author.connections)) {
        author.connections.forEach(function (targetId) {
          processedEdges.push({
            id: "".concat(author.id, "-").concat(targetId),
    ...
    var sanitizedEdges = processedEdges.map(function (ed) {
      var copy = _objectSpread({}, ed);
      if (copy.sourceHandle == null || copy.sourceHandle === 'undefined') delete copy.sourceHandle;
      if (copy.targetHandle == null || copy.targetHandle === 'undefined') delete copy.targetHandle;
      return copy;
    });
    return {
  ...
  (0,react.useEffect)(function () {
    try {
      setLoading(true);
      setError(null);
      var _processGraphData = processGraphData(),
        processedNodes = _processGraphData.nodes,
        processedEdges = _processGraphData.edges;
  ...
  if (error) {
    return /*#__PURE__*/react.createElement("div", {
      className: "O_canvasCards"
    }, /*#__PURE__*/react.createElement("div", {
      className: "error"
    }, /*#__PURE__*/react.createElement("h3", null, "\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445"), /*#__PURE__*/react.createElement("p", null, error)));
  }
  return /*#__PURE__*/react.createElement("div", {
    className: "O_canvasCards"
  ...
  }, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..."), /*#__PURE__*/react.createElement(ReactFlowProvider, null, /*#__PURE__*/react.createElement(FlowContent, {
    nodes: nodes,
    edges: edges,
    onNodesChange: onNodesChange,
    onEdgesChange: onEdgesChange,
...
/* harmony default export */ const O_canvasCards_O_canvasCards = (O_canvasCards);
;// ./src/javascript/entry-points/interview-graph.jsx
...
document.addEventListener('DOMContentLoaded', function () {
  var container = document.querySelector('.O_canvasCards');
  if (container) {
    var root = (0,client.createRoot)(container);
    root.render(/*#__PURE__*/react.createElement(O_canvasCards_O_canvasCards, null));
  }
});
/******/ })()
;