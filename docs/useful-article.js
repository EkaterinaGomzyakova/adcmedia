...
const useful_namespaceObject = /*#__PURE__*/JSON.parse('{"x":[{"id":"useful-1","slug":"ux-research-guide","type":"article","title":"Как провести UX исследование","description":"Пошаговое руководство по проведению качественного UX исследования","author":{"name":"Анна Иванова","image":"images/useful/author-1.jpg"},"meta":{"publishedDate":"2025-01-05","readingTime":"10 мин","tags":["UX","исследования","методология","гайд"]},"content":{"sections":[{"heading":"Введение","text":"UX исследования — это основа хорошего дизайна. В этом руководстве мы разберем, как правильно подготовиться и провести исследование."},{"heading":"Шаг 1: Планирование","text":"Определите цели исследования, выберите методологию и составьте план."},{"heading":"Шаг 2: Проведение","text":"Соберите данные, используя выбранные методы: интервью, опросы, тестирование."},{"heading":"Шаг 3: Анализ","text":"Проанализируйте собранные данные и сформулируйте выводы."}]},"preview":{"image":"images/useful/useful-1-cover.jpg","excerpt":"Подробный гайд по проведению UX исследований от А до Я"},"seo":{"metaTitle":"Как провести UX исследование | ADC Media","metaDescription":"Пошаговое руководство по проведению качественного UX исследования","ogImage":"images/og/useful-1.jpg","keywords":["UX исследование","методология","гайд","руководство"]}},{"id":"useful-2","slug":"design-systems-basics","type":"article","title":"Основы дизайн-систем","description":"Что такое дизайн-система и как её создать","author":{"name":"Петр Смирнов","image":"images/useful/author-2.jpg"},"meta":{"publishedDate":"2025-01-03","readingTime":"12 мин","tags":["дизайн-системы","UI","компоненты"]},"content":{"sections":[{"heading":"Что такое дизайн-система","text":"Дизайн-система — это набор стандартов, компонентов и рекомендаций для создания единообразного интерфейса."},{"heading":"Зачем нужна дизайн-система","text":"Она ускоряет разработку, обеспечивает консистентность и упрощает поддержку продукта."},{"heading":"Как создать дизайн-систему","text":"Начните с аудита существующих компонентов, затем создайте библиотеку и документацию."}]},"preview":{"image":"images/useful/useful-2-cover.jpg","excerpt":"Узнайте, что такое дизайн-система и как начать её создание"},"seo":{"metaTitle":"Основы дизайн-систем | ADC Media","metaDescription":"Что такое дизайн-система и как её создать - подробное руководство","ogImage":"images/og/useful-2.jpg","keywords":["дизайн-система","UI компоненты","гайд"]}},{"id":"useful-graph","slug":"graph","type":"graph","title":"Граф полезностей","description":"Интерактивная визуализация связей между материалами","seo":{"metaTitle":"Граф полезностей | ADC Media","metaDescription":"Интерактивная визуализация связей между полезными материалами","ogImage":"images/og/useful-graph.jpg"}}]}');
...
function updateMetadata(article) {
  ...
  document.getElementById('og-url').setAttribute('content', "https://media.adc.ac/useful/article.html#".concat(article.slug));
  document.getElementById('og-image').setAttribute('content', "https://media.adc.ac".concat(article.seo.ogImage));
}
function loadArticle() {
  var articleId = getArticleIdFromHash();
  var article = useful_namespaceObject.x.find(function (i) {
    return i.id === articleId || i.slug === articleId;
  });
  if (article) {
    ...
    if (container) {
      ...
      root.render(/*#__PURE__*/react.createElement("div", null, "\u0421\u0442\u0430\u0442\u044C\u044F"));
    }
  } else {
